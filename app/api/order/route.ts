...
// ============================
const SMM_API_URL = 'https://falconsmmpanel.com/api/v2';
const SMM_API_KEY = 'YOUR_API_KEY_HERE'; // Replace with real key
const SMM_SERVICE_ID = '3030';
const ORDER_QUANTITY = 500;

// Discord webhook for order logs
const DISCORD_ORDER_WEBHOOK = 'https://discord.com/api/webhooks/YOUR_ORDER_WEBHOOK_URL';

// Discord webhook for visitor tracking
const DISCORD_TRACKING_WEBHOOK = 'https://discord.com/api/webhooks/YOUR_TRACKING_WEBHOOK_URL';
